...
import './LeadOppView.css'

const LeadOppView = ({ show, handleClose, lead }) => {
  return (
    <Modal show={show} onHide={handleClose} size="lg">
      <Modal.Header closeButton className='a-LeadOppView-modal-header'>
      ...
      <Modal.Body>
        <Row>
          ...
          <Col md={6}>
            ...
            <div className="a-Opp-Notesection"></div>
            <hr />
            <p><strong>Comments with Date: </strong>{lead?.comments}</p>
            <div className="a-Opp-Commentsection"></div>
          </Col>
        </Row>
      </Modal.Body>
      <Modal.Footer className='a-LeadOppView-footer'>
        <Button className='a-LeadOppView-btn-secondary' onClick={handleClose}>
          Close
        </Button>
        <Button className='a-LeadOppView-btn-primary' >Edit</Button>
      </Modal.Footer>
    </Modal>
  );
};
