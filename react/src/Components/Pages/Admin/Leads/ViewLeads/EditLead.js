...
const EditLead = ({ show, handleClose, lead, handleSave }) => {
  ...
  return (
     <Modal show={show} onHide={handleClose} size="lg" centered>
       <Modal.Header closeButton className='a-edit-lead-header'>
         <Modal.Title>Edit Lead</Modal.Title>
       </Modal.Header>
       <Modal.Body>
         <Form className="a-edit-lead-FormLable">
       ...
       <Modal.Footer className='a-edit-lead-footer'>
         <Button className='a-edit-lead-btn-secondary' onClick={handleClose}>
           Close
         </Button>
         <Button className='a-edit-lead-btn-primary' onClick={handleFormSubmit}>
           Save Changes
         </Button>
       </Modal.Footer>
     </Modal>
