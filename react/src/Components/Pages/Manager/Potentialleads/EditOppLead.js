...
const EditOppLead = ({ show, handleClose, lead, handleSave }) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg" centered>
      <Modal.Header closeButton className='m-edit-opp-lead-header'>
        <Modal.Title>Edit Lead</Modal.Title>
      </Modal.Header>
      <Modal.Body>
      <Form className="m-edit-opp-lead-FormLable">
      ...
      <Modal.Footer className='m-edit-opp-lead-footer'>
        <Button className='m-edit-opp-lead-btn-secondary' onClick={handleClose}>
          Close
        </Button>
        <Button className='m-edit-opp-lead-btn-primary' onClick={handleFormSubmit}>
          Save Changes
        </Button>
      </Modal.Footer>
    </Modal>
