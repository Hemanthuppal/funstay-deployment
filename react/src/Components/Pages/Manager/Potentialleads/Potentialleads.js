      ...
      // { Header: 'Customer ID', accessor: 'customerid' },
      {
        ...
        Cell: ({ row }) => (
          <span
            ...
            onClick={() => navigate(`/m-potential-leads/${row.original.opportunityid}`)}
          >
            {row.original.name}
          </span>
        ),
...
      },
  ...
  return (
    <div className="manager-ViewOpportunitycontainer">
    <Navbar onToggleSidebar={setCollapsed} />
    <div className={`manager-ViewOpportunity ${collapsed ? "collapsed" : ""}`}>
      <div className="manager-ViewOpportunity-table-container">
        <Row className="mb-3">
