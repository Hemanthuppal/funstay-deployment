...
const EditLead = ({ show, handleClose, lead, handleSave }) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg" centered>
      <Modal.Header closeButton className='edit-lead-header'>
        <Modal.Title>Edit Lead</Modal.Title>
      </Modal.Header>
      <Modal.Body>
      <Form className="edit-lead-FormLable">
      ...
      <Modal.Footer className='edit-lead-footer'>
        <Button className='edit-lead-btn-secondary' onClick={handleClose}>
          Close
        </Button>
        <Button className='edit-lead-btn-primary' onClick={handleFormSubmit}>
          Save Changes
        </Button>
      </Modal.Footer>
    </Modal>
