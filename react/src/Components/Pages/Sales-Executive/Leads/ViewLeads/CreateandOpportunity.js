...
const CreateCustomerOpportunity = () => {
  ...
  const handleSubmitCustomer = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        Swal.fire({
          title: 'Success!',
          text: 'Customer data submitted successfully!',
          icon: 'success',
          confirmButtonText: 'OK',
        });
  
        setActiveTab("opportunity"); // Switch to opportunity tab
        // Add any additional logic if required after switching tabs
      }
    } catch (err) {
      ...
      Swal.fire({
        title: 'Error!',
        text: 'Failed to update customer data. Please try again.',
        icon: 'error',
        confirmButtonText: 'OK',
      });
    } finally {
  ...
  const handleSubmitOpportunity = async () => {
    ...
    try {
      ...
      Swal.fire({
        title: 'Error!',
        text: 'Failed to create opportunity. Please try again.',
        icon: 'error',
        confirmButtonText: 'OK',
      });
    } finally {
