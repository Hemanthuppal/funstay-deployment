      ...
      // { Header: "Customer ID", accessor: "customerid" },
      {
        ...
        Cell: ({ row }) => (
          <span
            ...
            onClick={() => navigate(`/potential-leads/${row.original.opportunityid}`)}
          >
            {row.original.name}
          </span>
        ),
  ...
  return (
    <div className="salesOpportunitycontainer">
      ...
      <div className={`salesOpportunity ${collapsed ? "collapsed" : ""}`}>
        <div className="salesOpportunity-table-container">
          <Row className="mb-3">
