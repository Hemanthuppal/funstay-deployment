...
const EditOppLead = ({ show, handleClose, lead, handleSave }) => {
  ...
  return (
    <Modal show={show} onHide={handleClose} size="lg" centered>
      <Modal.Header closeButton className='s-edit-opp-lead-header'>
        <Modal.Title>Edit Lead</Modal.Title>
      </Modal.Header>
      <Modal.Body>
      <Form className="s-edit-opp-lead-FormLable">
      ...
      <Modal.Footer className='s-edit-opp-lead-footer'>
        <Button className='s-edit-opp-lead-btn-secondary' onClick={handleClose}>
          Close
        </Button>
        <Button className='s-edit-opp-lead-btn-primary' onClick={handleFormSubmit}>
          Save Changes
        </Button>
      </Modal.Footer>
    </Modal>
